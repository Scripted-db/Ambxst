...
Item {
    ...
    property real workspaceImplicitWidth: (monitorData?.transform % 2 === 1) ? 
        ((monitor?.height || 1920) * scale) :
        ((monitor?.width || 1080) * scale)
    ...
    implicitWidth: overviewBackground.implicitWidth + 32
    implicitHeight: overviewBackground.implicitHeight + 32
    ...
    Rectangle {
        ...
        implicitWidth: workspaceColumnLayout.implicitWidth + 32
        implicitHeight: workspaceColumnLayout.implicitHeight + 32
                        ...
                        Rectangle {
                            ...
                            DropArea {
                                ...
                                onEntered: {
                                    ...
                                    if (overviewRoot.draggingFromWorkspace == overviewRoot.draggingTargetWorkspace) return;
